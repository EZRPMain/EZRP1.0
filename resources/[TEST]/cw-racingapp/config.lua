...
Config.DoOffsetGps = false -- Set to true if you want the gps to slighlty offset the point (helps with route)
...
Config.Ghosting = {
    ...
    NearestDistanceLimit = 0, -- Distance (in meters) a racer needs to be to a non-racer for the ghosting to turn off
