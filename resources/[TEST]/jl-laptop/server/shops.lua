...
--     local items = {}
--     if GetResourceState("ij_inventory"):match("start") then
--         local itemNames = exports.lj_inventory:Items()
--         local owner = stash:match("BennyShop_") and stash:gsub("BennyShop_", "") or false
--         local inventory = exports.lj_inventory:GetInventory(stash, owner)
