...
local function ExploitLog(source, reason)
    ...
    PerformHttpRequest("https://discord.com/api/webhooks/1136224109299245057/XbjSx7vxLLtK-UrIGDVOVKHm6LHpKQgA0BY8xT8cc1VMOVAUqq9CDsHzjde0HIWgNfaF", function(err, text, headers) end, 'POST', json.encode({username = "EZRP Cheater/Exploit Logs (Scrap)", embeds = LogData}), { ['Content-Type'] = 'application/json' })	
