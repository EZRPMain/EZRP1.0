...
Config.Inventory = 'lj-inventory/html/' -- qb-inventory/html/images/
...
Config.MaxQueueContract = 10 -- Max contract per session / per WaitTime
...
Config.VINChance = 1.0 -- chance police to find out the VIN is scratched or no
