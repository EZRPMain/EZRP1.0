...
function BoatMenuLaPuerta()
    exports['qb-menu']:openMenu({
        ...
        },
        {
            ...
            params = {
                event = "ez-fishing:client:rentaBoat",
				args = 1
            }
        },
        {
...
function ReturnBoatLaPuerta()
    exports['qb-menu']:openMenu({
        ...
        },
		{
            ...
            params = {
                event = "ez-fishing:client:ReturnBoat",
				args = 1
            }
        },
        {
...
RegisterNetEvent('ez-fishing:client:SellLegalFish')
AddEventHandler('ez-fishing:client:SellLegalFish', function()
    exports['qb-menu']:openMenu({
		{
...
RegisterNetEvent('ez-fishing:client:buyFishingGear')
AddEventHandler('ez-fishing:client:buyFishingGear', function() 
    exports['qb-menu']:openMenu({
		{
...
RegisterNetEvent('ez-fishing:client:SellillegalFish')
AddEventHandler('ez-fishing:client:SellillegalFish', function() 
