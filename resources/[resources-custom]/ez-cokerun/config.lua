...
Config.cdTime = 3600000 -- global cooldown in ms. Set to 20 minutes by default - (https://www.timecalculator.net/minutes-to-milliseconds)
...
Config.randBrick = function() return math.random(1,6) end-- change the numbers to how much coke you want players to receive after breaking down bricks
