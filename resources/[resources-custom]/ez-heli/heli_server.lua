...
-- 2017-08-15 Further modified by Loque
-- 2022-09-01 Added cross-communication for helicopters in use by BrianTU#0001

RegisterServerEvent('heli:server:cameraupdate')
AddEventHandler('heli:server:cameraupdate', function(vehicle, status)
	TriggerClientEvent('heli:client:cameraupdate', -1, vehicle, status)
end)
