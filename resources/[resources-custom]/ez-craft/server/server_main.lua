...
QBCore.Functions.CreateCallback('ez-craft:server:get_player_information', function(source, cb)
...
QBCore.Functions.CreateCallback('ez-craft:server:get_player_blueprints', function(source, cb)
     local Player = QBCore.Functions.GetPlayer(source)
...
local function StartCraftProcess(src, data)
     ...
     TriggerClientEvent("ez-craft:client:start_crafting", src, data, item_config)
...
RegisterServerEvent('ez-craft:check_materials_list', function(data)
     local src = source
     local Player = QBCore.Functions.GetPlayer(src)
     ...
     if item_config then
          TriggerClientEvent('ez-craft:client:local_mailer', src, {
               gender = gender,
               charinfo = charinfo,
...
--   EVENTS
--------------------
RegisterNetEvent('ez-craft:server:craft_item', function(data)
     local src = source
