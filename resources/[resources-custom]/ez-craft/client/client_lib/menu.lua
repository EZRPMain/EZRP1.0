...
local function updatePlayerBluePrints()
     QBCore.Functions.TriggerCallback('ez-craft:server:get_player_blueprints', function(result)
...
function menu:player_crafting_information()
     QBCore.Functions.TriggerCallback('ez-craft:server:get_player_information', function(result)
...
function menu:crafting_menu(item, data)
     ...
     local Menu = {
          ...
          },
          {
               ...
               action = function()
                    TriggerServerEvent('ez-craft:server:craft_item', {
                         type = 'sell',
          ...
          },
          {
               ...
               action = function()
                    TriggerServerEvent('ez-craft:check_materials_list', {
                         type = 'sell',
                         item = item,
                         id = Workbench.id
                    })
...
function QbMenu:main_categories()
          ...
          if category.sub_categories then
               Menu[#Menu + 1] = {
                    ...
                    params = {
                         ...
                         event = 'ez-craft:client_lib:sub_categories'
                    }
               }
          else
               Menu[#Menu + 1] = {
                    ...
                    params = {
                         ...
                         event = 'ez-craft:client_lib:crafting_items_list'
                    }
               }
          end
     end
     ...
     Menu[#Menu + 1] = {
          ...
          icon = 'fa-solid fa-circle-info',
          params = {
               event = 'ez-craft:client_lib:player_crafting_information'
          },
     }
          ...
          local Menu = {
               {
                    header = Lang:t("menu.back"),
                    params = {
                         event = 'ez-craft:client_lib:main_categories'
                    }
               },
               {
                    header = Lang:t('menu.your_name'),
               ...
               if craftingrep >= item.item_settings.level then
                    Menu[#Menu + 1] = {
                         ...
                         params = {
                              ...
                              event = 'ez-craft:client_lib:crafting_menu'
                         }
                    }
               end
          else
     ...
     local Menu = {
          ...
          },
          {
               ...
               params = {
                    ...
                    event    = 'ez-craft:server:craft_item',
                    isServer = true
               }
          },
          {
               ...
               params = {
                    ...
                    event = 'ez-craft:client_lib:check_materials_list'
               }
          },
          {
               header = Lang:t('menu.leave'),
...
AddEventHandler('ez-craft:client_lib:main_categories', function()
     Open_menu()
end)

AddEventHandler('ez-craft:client_lib:sub_categories', function(args)
     QbMenu:sub_categories(args)
end)

AddEventHandler('ez-craft:client_lib:player_crafting_information', function(args)
     QbMenu:player_crafting_information()
end)

AddEventHandler('ez-craft:client_lib:crafting_items_list', function(args)
     nui_traker = true
     QbMenu:crafting_items_list(args)
end)

AddEventHandler('ez-craft:client_lib:crafting_menu', function(args)
     QbMenu:crafting_menu(args)
end)

-- crafting_menu
AddEventHandler('ez-craft:client_lib:check_materials_list', function(args)
     TriggerServerEvent('ez-craft:check_materials_list', { type = args[1], item = args[2], id = args[3] })
end)
