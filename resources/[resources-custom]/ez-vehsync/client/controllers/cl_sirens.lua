...
function RequestSirenStateUpdate(pVehicle)
    ...
    Citizen.SetTimeout(50, function()
        ...
        TriggerServerEvent("ez-vehsync:updateSirenState", netId, sirenState, sirenPreset)
    end)
end
...
Citizen.CreateThread(function()
    -- exports['ps-accessibility']:AddKeyMapping("Apartments", "+enterapartment", "-enterapartment", "Enter", "keyboard", 'H')
    
    exports["jay-interactions"]:AddKeyMapping("Vehicle", "+toggleSirenLights", "-toggleSirenLights", "Siren Turn On/Off Lights", "keyboard", "Q")
    exports["jay-interactions"]:AddKeyMapping("Vehicle", "+toggleSiren", "-toggleSiren", "Siren Turn On/Off Sound", "keyboard", "LMENU")
    exports["jay-interactions"]:AddKeyMapping("Vehicle", "+cycleSiren", "-cycleSiren", "Siren Cycle Sound", "keyboard", "R")
    exports["jay-interactions"]:AddKeyMapping("Vehicle", "+sirenAirHorn", "-sirenAirHorn", "Siren AirHorn", "keyboard", "E")
end)