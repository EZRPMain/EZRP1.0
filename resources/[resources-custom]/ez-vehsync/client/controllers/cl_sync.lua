...
function SetEngineSound(pVehicle)
    -- local sound = exports["np-vehicles"]:GetVehicleAfterMarket(pVehicle, "engineSound")
...
function RequestSyncStateUpdate(pVehicle)
    ...
    Citizen.SetTimeout(50, function()
        ...
        TriggerServerEvent("ez-vehsync:updateSyncState", netId, syncState)
    end)
end
...
-- RegisterNetEvent("ez-vehicles:spawnedVehicleSync")
-- AddEventHandler("ez-vehicles:spawnedVehicleSync", function(pNetId, pModel)
--     Citizen.Wait(1000)
...
--     local afterMarkets = exports["ez-vehicles"]:GetVehicleAfterMarket(vehicle)
...
Citizen.CreateThread(function()
    exports["jay-interactions"]:AddKeyMapping("Vehicle", "+toggleNeonLights", "-toggleNeonLights", "Toggle Neon Lights")
    exports["jay-interactions"]:AddKeyMapping("Vehicle", "+toggleRightIndicator", "-toggleRightIndicator", "Toggle Light Indicator (Right)")
    exports["jay-interactions"]:AddKeyMapping("Vehicle", "+toggleLeftIndicator", "-toggleLeftIndicator", "Toggle Light Indicator (Left)")
    exports["jay-interactions"]:AddKeyMapping("Vehicle", "+toggleHazardLights", "-toggleHazardLights", "Toggle Light Indicator (Hazard)")
end)