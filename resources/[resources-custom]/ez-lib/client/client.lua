TriggerServerEvent("ez:sync:player:ready")
...
function syncNative(name, netEntity, options, ...)
    TriggerServerEvent("sync:executeSyncNative", name, netEntity, options, table.pack(...))
end
exports("syncNative", syncNative)

RegisterNetEvent("sync:clientExecuteSyncNative")
AddEventHandler("sync:clientExecuteSyncNative", function(native, netEntity, options, args)
