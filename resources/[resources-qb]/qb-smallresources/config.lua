...
Config.Discord = {
    ...
    ["Buttons"] = {
        {
            text = 'Discord',
            url = 'discord.gg/ePxWrZ9JsP'
        },
        {
            text = 'Join Ezrp!',
            url = 'https://eazy-website.bubbleapps.io/version-test/home_screen'
        }
    }
}
...
Config.MapText = "Los Santos, San Andreas" -- This is the name / text shown above the map
