...
local function ChannelsInRange(coords)
    local p = promise.new()
    QBCore.Functions.TriggerCallback("jay-radio:ChannelsInRange", function(r)
        p:resolve(r)
    end, coords)
...
-- Radio Scanner
RegisterNetEvent("jay-radio:scan", function()
...
RegisterNetEvent('jay-radio:use', function()
    toggleRadio(not radioMenu)
end)

RegisterNetEvent('jay-radio:onRadioDrop', function()
