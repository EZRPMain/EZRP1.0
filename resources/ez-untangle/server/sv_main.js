...
// CONCATENATED MODULE: ./src/server/controllers/events.ts
...
AddEventHandler("ez-untangle:updatePhoneStatus", (type, pObject) => {
    // todo: Update phone status, this is based on the phone u r using
});
EZRP.Procedures.register("ez-untangle:verify:userRank", async (pRank) => {
...
// CONCATENATED MODULE: ./src/server/controllers/index.ts
async function Init() {
    await InitEvents();
}
