...
RegisterServerEvent('ps-methrun:server:rewardpayout', function ()
    ...
    TriggerClientEvent('inventory:client:ItemBox', src, QBCore.Shared.Items["meth_cured"], "remove", 20)
    ...
    if chance >= 85 then
        ...
        TriggerClientEvent('inventory:client:ItemBox', src, QBCore.Shared.Items[Config.Item], "add", Config.MethAmount)
    end
...
RegisterServerEvent('ps-methrun:server:givecaseitems', function ()
	...
	TriggerClientEvent('inventory:client:ItemBox', src, QBCore.Shared.Items["meth_cured"], "add", 20)
