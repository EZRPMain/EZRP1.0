...
function FormatItemInfo(itemData, dom) {
    ...
    if (itemData != null && itemData.info != "") {
        ...
        } else if (itemData.name == "blueprint_document") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html(
                ...
                if (item != null) {
                    ...
                    if (item.slot == 41) {
                        $(".z-hotbar-inventory")
                            .find("[data-zhotbarslot=" + item.slot + "]")
                            .html(
                                '<div class="z-hotbar-item-slot-key"><p>6 <i style="top: -62px; left: 58px;" class="fas fa-lock"></i></p></div><div class="z-hotbar-item-slot-img"><img src="' +
                                item.image +
                                '" alt="' +
                                item.name +
