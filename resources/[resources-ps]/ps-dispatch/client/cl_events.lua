local WeaponTable = {
    [`weapon_ak47`] = "CLASS 3: AK-47",
    [`weapon_de`] = "CLASS 2: Desert Eagle",
    [`weapon_fnx45`] = "CLASS 1: FN .45",
    [`weapon_glock17`] = "CLASS 1: Glock 17",
    [`weapon_m4`] = "CLASS 3: M4",
    [`weapon_hk416`] = "CLASS 3: HK-416",
    [`weapon_mk14`] = "CLASS 4: MK 14",
    [`weapon_mk14`] = "CLASS 4: M110",
    [`weapon_huntingrifle`] = "CLASS 3: Hunting Rifle",
    [`weapon_ar15`] = "CLASS 3: AR-15",
    [`weapon_m9`] = "CLASS 1: M9",
    [`weapon_m70`] = "CLASS 3: m70",
    [`weapon_m1911`] = "CLASS 1: 1911",
    [`weapon_mac10`] = "CLASS 2: Mac-10",
    [`weapon_uzi`] = "CLASS 2: Uzi",
