...
exports("Login", QBCore.Player.Login)
...
exports("GetOfflinePlayer", QBCore.Player.GetOfflinePlayer)
...
exports("CheckPlayerData", QBCore.Player.CheckPlayerData)
...
exports("Logout", QBCore.Player.Logout)
...
function QBCore.Player.CreatePlayer(PlayerData, Offline) -- WIP
    local self = {}
    self.Functions = {}
    ...
    -- exports("UpdatePlayerData", self.Functions.UpdatePlayerData)
...
exports("CreatePlayer", QBCore.Player.CreatePlayer) -- WIP
...
exports("AddPlayerMethod", QBCore.Player.AddPlayerMethod)
...
exports("AddPlayerField", QBCore.Player.AddPlayerField)
...
exports("Save", QBCore.Player.Save)
...
exports("SaveOffline", QBCore.Player.SaveOffline)
...
exports("DeleteCharacter", QBCore.Player.DeleteCharacter)
...
exports("ForceDeleteCharacter", QBCore.Player.ForceDeleteCharacter)
...
exports("SaveInventory", QBCore.Player.SaveInventory)
...
exports("CreateCitizenId", QBCore.Player.CreateCitizenId)
...
exports("CreateAccountNumber", QBCore.Player.CreateAccountNumber)
...
exports("CreatePhoneNumber", QBCore.Player.CreatePhoneNumber)
...
exports("CreateFingerId", QBCore.Player.CreateFingerId)
...
exports("CreateWalletId", QBCore.Player.CreateWalletId)
...
exports("CreateSerialNumber", QBCore.Player.CreateSerialNumber)
