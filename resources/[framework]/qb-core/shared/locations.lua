...
exports("GetSharedLocations", function()
    return QBShared.Locations
end)

exports("GetSharedLocation", function(loc)
    if not QBShared.Locations[loc] then return false end
    return QBShared.Locations[loc]
end)