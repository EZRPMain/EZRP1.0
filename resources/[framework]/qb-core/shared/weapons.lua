...
exports("GetSharedWeapons", function()
    return QBShared.Weapons
end)

exports("GetSharedWeapon", function(weapon)
    if not QBShared.Weapons[weapon] then return false end
    return QBShared.Weapons[weapon]
end)