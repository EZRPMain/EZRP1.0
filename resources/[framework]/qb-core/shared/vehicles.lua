...
QBShared.Vehicles = {
    ...
    ['asbo'] = { -- This has to match the spawn code of the vehicle
        ...
        ['price'] = 18000, -- The price that the vehicle sells for
...
exports("GetSharedVehicle", function(veh)
    if not QBShared.Vehicles[veh] then return false end
    return QBShared.Vehicles[veh]
end)