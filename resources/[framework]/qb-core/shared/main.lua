...
exports("ChangeVehicleExtra", ChangeVehicleExtra)
...
exports("SetDefaultVehicleExtras", SetDefaultVehicleExtras)
...
exports("GetSharedMaleNoGloves", function()
    return QBShared.MaleNoGloves
end)
exports("IsMaleNoGloves", function(num)
    num = tonumber(num)
    if not QBShared.MaleNoGloves[num] then return false end
    return QBShared.MaleNoGloves[num]
end)
...
exports("GetSharedFemaleNoGloves", function()
    return QBShared.FemaleNoGloves
end)
exports("IsFemaleNoGloves", function(num)
    num = tonumber(num)
    if not QBShared.FemaleNoGloves[num] then return false end
    return QBShared.FemaleNoGloves[num]
end)
