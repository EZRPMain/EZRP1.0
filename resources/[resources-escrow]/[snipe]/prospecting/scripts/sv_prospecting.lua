...
local function AddItem(id, name, amount)
    ...
    if Player then
        ...
        TriggerClientEvent("inventory:client:ItemBox", id, Framework:GetSharedItem(name), "add", amount)
    end
end
...
CreateThread(function()
    Framework:CreateUseableItem(Config.DetectorItem, function(source, item)
