Config = {
	Guild_ID = '1053842293456642098', -- Set to the ID of your guild (or your Primary guild if using Multiguild)
	Multiguild = false, -- Set to true if you want to use multiple guilds
	Guilds = {
		["name"] = "guild_id", -- Replace this with a name, like "main"
	},
	Bot_Token = 'MTEyOTg4NjQyNjU0NTI2MjYwMg.GWv9_7.9zn5VESmPIQRJSyIRuCUuBVYbUVSnEUfU371ek',
	RoleList = {},
	DebugScript = false,
