        ...
        QBCore.Functions.CreateUseableItem(k, function(source, item)
            ...
            if Player.Functions.RemoveItem(k, 1) then
                ...
                SetTimeout(9500, function()
                    if Config.Rewards[k][random]['item'] == "carslip" then
                        exports['jay-carslips']:GenerateCarslip(source, Config.Rewards[k][random]['car'])
                    elseif Player.Functions.AddItem(Config.Rewards[k][random]['item'], 1) then
